@testset ExtendedTestSet "uniformrandom_multidomain.jl"  begin
...
@test MINDF.compileintent!(ibnfs[1], intentuuid_bordernode, MINDFC.UniformRandomCompilation(0, 5)) == ReturnCodes.SUCCESS
